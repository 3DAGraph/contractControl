...
contract Lucky10 is layer, layerprofit, random, ContractInfo{
    ...
    function gun_lucky10() public payable returns (address){
            ...
            if(now>lotteryinittime_lucky10+21600&&lotteryPeopleNum_L10>1){
                if(pool_lucky10[pooln_lucky10 - randomLottery(10000,uint(lotteryPeopleNum_L10))].player!=0x0000000000000000000000000000000000000000){
                    pool_lucky10[pooln_lucky10 - randomLottery(10000,uint(lotteryPeopleNum_L10))].player.transfer(lotterybalance_L10*50/100);
